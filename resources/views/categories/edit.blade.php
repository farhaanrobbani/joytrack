            ...
            <form method="POST" action="{{ route('categories.update', $category) }}">
                ...
                <div class="space-y-6">
                    ...
                    <div class="flex items-center">
                        ...
                        <input id="is_active" name="is_active" type="checkbox" value="1" class="rounded border-gray-300 text-emerald-600 focus:ring-emerald-500" {{ old('is_active', $category->is_active) ? 'checked' : '' }}>
